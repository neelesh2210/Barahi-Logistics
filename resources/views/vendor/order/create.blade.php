                        ...
                        <form class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 pt-2">
                                    ...
                                    <select name="branch_id" id="branch_id" class="form-control" required>
                                        @foreach (App\Models\Admin\Branch::orderBy('branch_name','asc')->get() as $branch)
                                            <option value="{{$branch->id}}" selected disabled>{{$branch->branch_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 pt-2">
                                ...
                                <div class="col-md-6 pt-2">
                                    ...
                                    <input type="text" name="receiver_phone" id="receiver_phone" class="form-control" placeholder="Receiver Phone...">
                                </div>
                                <div class="col-md-6 pt-2">
                                ...
                                <div class="col-md-6 pt-2">
                                    ...
                                    <input type="number" step="0.01" name="cod_charge" id="cod_charge" class="form-control" value="1" placeholder="COD Charge...">
                                </div>
                                <div class="col-md-6 pt-2">
